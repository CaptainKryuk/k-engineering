  ...
  data() {
    return {
      materials: [
        ...
        {id: 1, name: 'spectrum', text: 'Сила цветов безгранична. Цвет рассказывает историю, дает возможность показать, кто вы есть. План или свобода, разум или эмоции. Выбор за вами. Спектр дает вам свободу выбора.'},
        {id: 2, name: 'atelier', text: 'Сила воображения, игра в инновации и дизайн. С Atelier вы можете создавать продукты, которые задают тон будущему'},
        {id: 3, name: 'textile', text: 'Текстиль - это переплетный материал с широким спектром возможностей. Тиснение фольгой, слепое тиснение, трафаретная печать. Текстиль придает естественный вид и вашим продуктам'}
      ],
